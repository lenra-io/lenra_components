defmodule UIValidator.JsonSchemata do
  ...
  @impl true
  def init(_) do
    root_json_directory = Application.app_dir(:lenra, Application.fetch_env!(:lenra, :json_validator_schema_dir))
  ...
  def read_schema(path) do
    Application.app_dir(:lenra, Application.fetch_env!(:lenra, :json_validator_schema_dir))
    |> Path.join(path)
    |> File.read()
    |> case do
