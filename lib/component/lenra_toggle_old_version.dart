...
class _LenraToggleState extends State<LenraToggle> with SingleTickerProviderStateMixin {
  ...
  Widget _buildLabel() {
    return Text(
      widget.label!,
      style: TextStyle(
        color: widget.disabled ? widget.style!.disabledLabelColor : widget.style!.labelColor,
...
class _LenraSwitch extends AnimatedWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final ColorTween colorTween = ColorTween(begin: toggle.style!.inactiveColor, end: toggle.style!.activeColor);
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          color: toggle.disabled ? toggle.style!.disabledColor : colorTween.evaluate(animation)),
      child: Align(
