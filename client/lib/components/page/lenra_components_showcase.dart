...
class LenraComponentsShowcase extends StatelessWidget {
  ...
  final LenraTextField myTextField = LenraTextField(
    hintText: "check error button",
  );
        ...
        child: Column(children: [
          ...
          new Row(
            children: [
              ...
              LenraTextField(
                size: LenraTextFieldSize.Small,
                hintText: "small",
                label: "small",
                description: "small",
              ),
              LenraTextField(
                size: LenraTextFieldSize.Medium,
                hintText: "medium",
                label: "medium",
                description: "medium",
              ),
              ...
              TextButton(
                onPressed: () => {
                  if (myTextField.key.currentState.getValue() != "")
                    {
                      myTextField.key.currentState.setError(true),
                    }
                  else
                    {
                      myTextField.key.currentState.setError(false),
                    },
                },
                child: Row(
                  children: [
